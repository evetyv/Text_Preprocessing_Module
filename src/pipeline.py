...
class LectureProcessingPipeline:
    ...
    def process(self, file_path: str) -> ProcessingResult:
        ...
        try:
            ...
            # Шаг 3: Поиск и обработка формул
            logger.debug("Шаг 3: Поиск формул")
    ...
    def _create_text_chunks(self, 
        ...
        Args:
            chunks_info: Информация о блоках от сплиттера
            formula_result: Результат извлечения формул
            original_normalized_text: Оригинальный нормализованный текст
        ...
        for i, chunk_info in enumerate(chunks_info):
            # Восстанавливаем формулы в тексте блока
